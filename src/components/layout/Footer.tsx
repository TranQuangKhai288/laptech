...
const Footer: React.FC = () => {
  return (
    <footer className="border-t bg-muted/50 transition-colors duration-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-foreground">LapTech</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Chuyên cung cấp laptop chất lượng cao với giá cả hợp lý. Chúng tôi
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            © 2024 LapTech. Tất cả quyền được bảo lưu.
          </p>
